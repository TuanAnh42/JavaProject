...
//        });
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        boolean checkUser = !(Patternform.GetUserName(username));
        boolean checkEmail = !(Patternform.GetEmail(email));
        boolean checkPass = !(Patternform.GetPass(pass));
        boolean isNull = (username.equals("") || email.equals("") || age.equals("") || phone.equals("") || address.equals("") || pass.equals(""));
        if (isNull) {
