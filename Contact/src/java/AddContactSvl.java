 ...
 * @author Tuấn Anh
 */
@WebServlet(urlPatterns = {"/AddContactSvl"})
public class AddContactSvl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean isCheck = new AddContact().add(c);
            if (isCheck) {
                response.sendRedirect("ContactSvl");
            }
