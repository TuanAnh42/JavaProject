...
<html>
    ...
    <form action="AddContactSvl" method="POST">
        <h1 >Add a Contact</h1>
        <%
        ...
        <button type="submit" name="btnAddContact" value="AddContact"><a href="ListContact.jsp">Add </a></button>
        <button name="btnReturnContactList" value="ReturnContactist"><a href="ListContact.jsp">Return To Contact List</a></button>
    </form>
